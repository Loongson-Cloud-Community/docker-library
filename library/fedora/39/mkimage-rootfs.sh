...
output="fedora-${version}.rootfs.${arch}.tar.gz"

#repos_baseos_url="http://10.130.200.246/chenguoqi/fedora/hawhide/loongarch64"
repos_baseos_url="https://mirrors.wsyu.edu.cn/fedora/linux/development/rawhide//Everything/loongarch64/os/"
...
repo_conf="${repo_dir}/fedora.repo"
setting_scripts=setting.sh

pkg_list="
 basesystem bash ca-certificates fedora-release fedora-gpg-keys
 fedora-repos chkconfig cracklib crypto-policies  dnf
 expat gawk gdbm glib2 gmp gnupg2 gpgme grep
